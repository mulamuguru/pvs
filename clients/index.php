...
<div class="wrapper d-flex">
    ...
    <div class="sidebar text-white p-3" style="min-height: 100vh; width: 250px;">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a href="index.php" class="nav-link active text-white"> Clients</a></li>
    ...
    <div class="content flex-grow-1 d-flex flex-column">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
            <span class="navbar-brand mb-0 h1">officer Dashboard</span>
            <div class="ml-auto">
                <span class="navbar-text">Welcome, Officer</span>
            </div>
        </nav>
